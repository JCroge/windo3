...
HARD_LIMITS = {
    ...
    "tactical_very_near_position_pct": (0.1, 1.0),
    "tactical_stop_cap_r_main": (0.1, 1.0),
    "tactical_very_near_stop_r_main": (0.1, 1.0),
    "tactical_tp1_r": (0.1, 3.0),
    "tactical_cost_coverage_min": (0.0, 20.0),
    "tactical_min_rr_for_track": (0.0, 3.0),
    "tactical_min_ev_for_track": (-100.0, 100.0),
    "tactical_max_hold_minutes": (1, 1440),
    "tactical_min_progress_r": (0.0, 3.0),
    "tactical_weakened_no_progress_min_minutes": (1, 1440),
    "tactical_weakened_no_progress_max_minutes": (1, 1440),
    "tactical_daily_loss_limit_usdt": (-10000.0, -0.1),
    "tactical_loss_streak_pause_count": (1, 20),
    "tactical_loss_streak_pause_minutes": (1, 1440),
    "tactical_quality_window_trades": (1, 500),
    "tactical_success_window_trades": (1, 500),
    "tactical_success_min_win_rate": (0.0, 1.0),
    "tactical_success_min_profit_factor": (0.1, 10.0),
...
DEFAULTS = {
    ...
    "low_rr_extra_slot": 1,
    # Tactical exit track: default shadow-only until replay/live validation passes.
...
def _read_env_overrides() -> dict:
    ...
    env_map = {
        ...
        "MAIN_QUALITY_REQUIRE_VOLUME_OR_OI": ("main_quality_require_volume_or_oi", _to_bool),
        "TACTICAL_MAX_LEVERAGE": ("tactical_max_leverage", int),
        "TACTICAL_DEFAULT_POSITION_PCT": ("tactical_default_position_pct", float),
        "TACTICAL_VERY_NEAR_POSITION_PCT": ("tactical_very_near_position_pct", float),
        "TACTICAL_STOP_CAP_R_MAIN": ("tactical_stop_cap_r_main", float),
        "TACTICAL_VERY_NEAR_STOP_R_MAIN": ("tactical_very_near_stop_r_main", float),
        "TACTICAL_TP1_R": ("tactical_tp1_r", float),
        "TACTICAL_COST_COVERAGE_MIN": ("tactical_cost_coverage_min", float),
        "TACTICAL_MIN_RR_FOR_TRACK": ("tactical_min_rr_for_track", float),
        "TACTICAL_MIN_EV_FOR_TRACK": ("tactical_min_ev_for_track", float),
        "TACTICAL_MAX_HOLD_MINUTES": ("tactical_max_hold_minutes", int),
        "TACTICAL_MIN_PROGRESS_R": ("tactical_min_progress_r", float),
        "TACTICAL_WEAKENED_NO_PROGRESS_MIN_MINUTES": ("tactical_weakened_no_progress_min_minutes", int),
        "TACTICAL_WEAKENED_NO_PROGRESS_MAX_MINUTES": ("tactical_weakened_no_progress_max_minutes", int),
        "TACTICAL_DAILY_LOSS_LIMIT_USDT": ("tactical_daily_loss_limit_usdt", float),
        "TACTICAL_LOSS_STREAK_PAUSE_COUNT": ("tactical_loss_streak_pause_count", int),
        "TACTICAL_LOSS_STREAK_PAUSE_MINUTES": ("tactical_loss_streak_pause_minutes", int),
        "TACTICAL_QUALITY_WINDOW_TRADES": ("tactical_quality_window_trades", int),
        "TACTICAL_SUCCESS_WINDOW_TRADES": ("tactical_success_window_trades", int),
        "TACTICAL_SUCCESS_MIN_WIN_RATE": ("tactical_success_min_win_rate", float),
        "TACTICAL_SUCCESS_MIN_PROFIT_FACTOR": ("tactical_success_min_profit_factor", float),
