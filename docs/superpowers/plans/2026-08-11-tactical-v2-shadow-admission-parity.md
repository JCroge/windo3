...
- [x] **Step 1: Add the failing neutral renewal test**
...
- [x] **Step 2: Add the negative cases before implementation**
...
- [x] **Step 3: Run the focused tests and confirm the bug is red**
...
- [x] **Step 4: Implement the minimal reset rule**
...
- [x] **Step 5: Run the episode tests and restart coverage**
...
- [x] **Step 6: Commit the episode change**
...
- [x] **Step 1: Add receipt tests before implementation**
...
- [x] **Step 3: Extend the handler boundary with message identity**
...
- [x] **Step 4: Pass `msg_id` from Executor and replay paths**
...
- [x] **Step 5: Verify receipt replay behavior**
...
- [x] **Step 6: Commit the receipt change**
...
- [x] **Step 1: Create a sanitized 22-candidate fixture**
...
- [x] **Step 2: Add the failing replay assertions**
...
- [x] **Step 3: Run the replay test before implementation integration**
...
- [x] **Step 4: Implement the replay driver**
...
- [x] **Step 5: Run the 100-loop replay and targeted suite**
...
- [x] **Step 6: Commit the replay change**
...
- [x] **Step 1: Add the operator-facing distinction**
...
- [x] **Step 2: Run the focused Tactical V2 suite**
...
- [x] **Step 3: Run repository verification and static checks**
...
- [x] **Step 4: Commit operational documentation and mark tasks complete**
...
### Bounded Follow-Up: Multiprocessing Test And Operations Audit

**Files:**
- Modify: `tests/test_tactical_v2_concurrency.py`
- Modify: `README.md`
- Modify: `docs/integration-guide.md`
- Modify: `docs/to-do-list.md`
- Modify: `docs/superpowers/reports/2026-08-12-tactical-v2-shadow-admission-parity-verify.md`

- [x] Add a red regression proving a timed-out child is terminated and reaped.
- [x] Add bounded queue-result collection and a missing-result regression.
- [x] Route the candidate-admission multiprocessing test through bounded joins, explicit exit-code assertions, bounded queue reads, and queue cleanup.
- [x] Audit operational wording so the concurrency claim is limited to ledger sequence and candidate admission/receipt transactions.
- [x] State the current live precondition: one active Main per namespace/account; overlapping Main live lifecycle is not fenced.
- [x] Run the focused concurrency test file and record the fresh result without replacing historical full-suite evidence.
