...
生成时间：2026-05-28T10:29:04.229866+00:00
...
| case | result | notes |
|---|---|---|
| T0 | FAIL | 至少一个 OKX REST 端点经 3 次重试仍未通过 code=0 校验 |

## 详情（每个 case 的 ledger_diff / resolution）

### T0 — FAIL
- executed_at: 2026-05-28T10:26:27.887843+00:00
- notes: 至少一个 OKX REST 端点经 3 次重试仍未通过 code=0 校验
- resolution:
  ```json
  {}
  ```
