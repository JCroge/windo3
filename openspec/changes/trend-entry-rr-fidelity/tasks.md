...
- [x] 4.1 灰度决策:lever1+lever2 **均保持默认关**(lever2 单笔正期望但样本薄 13%/近3天,不足以动实盘;lever1 未验证)。不全量、不小灰度,待数据累积
- [x] 4.2 全量回归测试零回退;更新相关文档/记忆
- [x] 4.3 登记后续拆出 change:① P2 bias 上游根治、① lever1 A/B(待 tech_context 埋点数据累积)、② v2 到达概率频率校准、② lever2 组合层 slot/EV 瓶颈诊断 + 数据累积后重评灰度
