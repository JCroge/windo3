...
- [x] 1.3 跑 30 币 × 1d 入库:28229 根(多数 2.75 年起 2023-09;新币 TRUMP/ONDO/TON/TAO/ENA 短史已标注)。4h 30000 根但仅 5.5 月(分页 bug,4h 确认时再修向后分页)
- [x] 1.4 入库后自检:已打印每币根数 + 起始日期 + 短史标注;入库汇总 ('1d',28229,30) ('4h',30000,30)
